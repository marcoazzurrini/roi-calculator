...
const formSchema = z.object({
  ...
  returnsPerYear: z.coerce.number().positive(),
  customerTerms: z.coerce.number().positive(),
  referrals: z.coerce.number().positive(),
});
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Customer Tersm In Years</FormLabel>
                  <FormControl>
